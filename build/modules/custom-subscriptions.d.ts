 ...
 */
export declare function subscribeStates(pattern: string | RegExp, callback: (id: string, state: ioBroker.State | null | undefined) => void): string | undefined;
/**
 ...
 * @returns a subscription ID
 */
export declare function subscribeObjects(pattern: string | RegExp, callback: (id: string, object: ioBroker.Object | null | undefined) => void): string | undefined;
/**
 * Release the custom subscription with the given id
