...
export declare class IPSOObject {
    ...
    private parseValue(propKey, value, deserializer?, requiresArraySplitting?);
    /**
 ...
 */
export declare const deserializeWith: (transform: PropertyTransform, splitArrays?: boolean) => PropertyDecorator;
