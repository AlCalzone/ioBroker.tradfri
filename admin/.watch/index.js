...
For more info, visit https://reactjs.org/link/mock-scheduler`);
  ...
  var require_tooltip = __commonJS({
    "node_modules/iobroker-react-components/build/components/tooltip.js"(exports) {
      "use strict";
      Object.defineProperty(exports, "__esModule", { value: true });
      var React4 = require_react();
      function Tooltip2(props) {
        return React4.createElement("i", { className: "material-icons", title: _(props.text) }, "live_help");
      }
  ...
  var require_label = __commonJS({
    "node_modules/iobroker-react-components/build/components/label.js"(exports) {
      "use strict";
      Object.defineProperty(exports, "__esModule", { value: true });
      var React4 = require_react();
      ...
      function Label2(props) {
        ...
        return React4.createElement("label", { htmlFor: props.for, className: classNames.join(" ") }, _(props.text), props.tooltip != null && React4.createElement(tooltip_1.Tooltip, { text: props.tooltip }));
      }
  ...
  var require_multi_dropdown = __commonJS({
    "node_modules/iobroker-react-components/build/components/multi-dropdown.js"(exports) {
      "use strict";
      Object.defineProperty(exports, "__esModule", { value: true });
      var React4 = require_react();
      var M_Select = M.FormSelect || M.Select;
      var MultiDropdown2 = class extends React4.Component {
        constructor(props) {
          super(props);
        ...
        render() {
          return React4.createElement("select", { multiple: true, ref: (me) => this.dropdown = me, defaultValue: this.props.checkedOptions }, React4.createElement("option", { value: "", disabled: true }, _("select devices")), Object.keys(this.props.options).map((k) => React4.createElement("option", { key: k, value: k }, this.props.options[k])));
        }
      };
      MultiDropdown2.defaultProps = {
        checkedOptions: []
      };
      exports.MultiDropdown = MultiDropdown2;
    }
  });

  // node_modules/iobroker-react-components/build/components/tabs.js
  var require_tabs = __commonJS({
    "node_modules/iobroker-react-components/build/components/tabs.js"(exports) {
      "use strict";
      Object.defineProperty(exports, "__esModule", { value: true });
      var React4 = require_react();
      var Tabs2 = class extends React4.Component {
        constructor(props) {
          super(props);
        }
        render() {
          return React4.createElement("div", { className: "row", id: this.props.id }, React4.createElement("div", { className: "tabs-header col s12" }, React4.createElement("ul", { className: "tabs" }, this.props.labels.map((k, i) => React4.createElement("li", { className: `tab col s${this.props.tabSize}`, key: i }, React4.createElement("a", { href: `#${this.props.id}-${i}` }, _(k)))))), React4.Children.map(this.props.children, (child, i) => React4.createElement("div", { className: "col s12", key: i, id: `${this.props.id}-${i}` }, child)));
        }
      };
      Tabs2.defaultProps = {
        id: "tabs",
  ...
  var require_cancelable_input = __commonJS({
    "node_modules/iobroker-react-components/build/components/cancelable-input.js"(exports) {
      "use strict";
      Object.defineProperty(exports, "__esModule", { value: true });
      var React4 = require_react();
      var CancelableInput2 = class extends React4.Component {
        constructor(props) {
          super(props);
          this.beginEdit = () => {
        ...
        render() {
          return React4.createElement("input", { type: "text", ref: (me) => {
            this.txtEdit = me;
  ...
  var $window = window;
  var instance = $window.instance || 0;
  var _2 = $window._ || ((text) => text);
  var socket = $window.socket;
  var sendTo = $window.sendTo;

  // admin/src/index.tsx
  var import_iobroker_react_components3 = __toESM(require_build());

  // admin/src/pages/groups.tsx
  var React = __toESM(require_react());
  var import_iobroker_react_components = __toESM(require_build());
  var ADD_GROUP_BUTTON_ID = "btnAddGroup";
  var Groups = class extends React.Component {
    constructor(props) {
      super(props);
    }
    addGroup() {
    ...
    render() {
      return /* @__PURE__ */ React.createElement(React.Fragment, null, /* @__PURE__ */ React.createElement("p", {
        ...
        id: ADD_GROUP_BUTTON_ID,
        onClick: this.addGroup,
        className: "btn"
      }, /* @__PURE__ */ React.createElement("i", {
        className: "material-icons left"
      }, "library_add"), _2("add group"))), /* @__PURE__ */ React.createElement("table", {
        id: "virtual-groups"
      }, /* @__PURE__ */ React.createElement("thead", null, /* @__PURE__ */ React.createElement("tr", null, /* @__PURE__ */ React.createElement("td", {
        className: "id"
      }, _2("ID")), /* @__PURE__ */ React.createElement("td", {
        className: "name"
      }, _2("Name")), /* @__PURE__ */ React.createElement("td", {
        className: "devices"
      }, _2("Devices")), /* @__PURE__ */ React.createElement("td", {
        className: "delete"
      }))), /* @__PURE__ */ React.createElement("tbody", null, this.props.groups && Object.keys(this.props.groups).length > 0 ? Object.keys(this.props.groups).map((k) => this.props.groups[k]).map((group) => {
        console.log("Rendering group: " + JSON.stringify(group));
        return /* @__PURE__ */ React.createElement("tr", {
          key: group.id
        }, /* @__PURE__ */ React.createElement("td", null, group.id), /* @__PURE__ */ React.createElement("td", null, /* @__PURE__ */ React.createElement(import_iobroker_react_components.CancelableInput, {
          text: group.name,
          maxLength: 100,
          textChanged: (newText) => this.renameGroup(group.id, newText)
        })), /* @__PURE__ */ React.createElement("td", null, this.props.devices && Object.keys(this.props.devices).length > 0 ? /* @__PURE__ */ React.createElement(import_iobroker_react_components.MultiDropdown, {
        ...
        }) : _2("no devices")), /* @__PURE__ */ React.createElement("td", null, /* @__PURE__ */ React.createElement("button", {
          title: _2("delete group"),
        ...
        className: "empty",
        colSpan: 4
      }, _2("No virtual groups defined"))))), /* @__PURE__ */ React.createElement("p", null, _2("changes are live")));
    }
  };

  // admin/src/pages/settings.tsx
  var React2 = __toESM(require_react());
  var import_iobroker_react_components2 = __toESM(require_build());
  function Label(props) {
    const classNames = props.class || [];
    return /* @__PURE__ */ React2.createElement("label", {
      htmlFor: props.for,
      className: classNames.join(" ")
    }, _2(props.text), props.tooltip != null && /* @__PURE__ */ React2.createElement(import_iobroker_react_components2.Tooltip, {
      text: props.tooltip
    }));
  }
  ...
  var Settings = class extends React2.Component {
    constructor(props) {
      super(props);
      this.state = {
        ...props.settings
    ...
    getSetting(key, defaultValue) {
      ...
      return ret != void 0 ? ret : defaultValue;
    }
    ...
    componentWillUnmount() {
      for (const checkbox of [
        ...
        if (checkbox)
          $(checkbox).off("click", this.handleChange);
      }
    }
    componentDidMount() {
      M.updateTextFields();
      for (const checkbox of [
        ...
        if (checkbox)
          $(checkbox).on("click", this.handleChange);
      }
    }
    render() {
      return /* @__PURE__ */ React2.createElement(React2.Fragment, null, /* @__PURE__ */ React2.createElement("div", {
        ...
        className: "value",
        id: "host",
        value: this.getSetting("host"),
        onChange: this.handleChange
      }), /* @__PURE__ */ React2.createElement(Label, {
        for: "host",
        text: "Gateway IP/Hostname:",
        tooltip: "hostname tooltip"
      })), /* @__PURE__ */ React2.createElement("div", {
        className: "col s3 input-field"
      }, /* @__PURE__ */ React2.createElement("label", {
        htmlFor: "discoverGateway"
      }, /* @__PURE__ */ React2.createElement("input", {
        type: "checkbox",
        className: "value",
        id: "discoverGateway",
        defaultChecked: this.getSetting("discoverGateway"),
        ref: (me) => this.chkDiscoverGateway = me
      }), /* @__PURE__ */ React2.createElement(CheckboxLabel, {
        text: "Auto-discover",
        tooltip: "discovery tooltip"
      }))), /* @__PURE__ */ React2.createElement("div", {
        ...
        className: "value",
        id: "securityCode",
        value: this.getSetting("securityCode"),
        onChange: this.handleChange
      }), /* @__PURE__ */ React2.createElement(Label, {
        for: "securityCode",
        text: "Security-Code:",
        tooltip: "security code tooltip"
      }))), /* @__PURE__ */ React2.createElement("div", {
        className: "row"
      }, /* @__PURE__ */ React2.createElement("div", {
        className: "col s6 input-field"
      }, /* @__PURE__ */ React2.createElement("label", {
        htmlFor: "preserveTransitionTime"
      }, /* @__PURE__ */ React2.createElement("input", {
        type: "checkbox",
        className: "value",
        id: "preserveTransitionTime",
        defaultChecked: this.getSetting("preserveTransitionTime"),
        ref: (me) => this.chkPreserveTransitionTime = me
      }), /* @__PURE__ */ React2.createElement(CheckboxLabel, {
        text: "Preserve transition time",
        tooltip: "transition time tooltip"
      }))), /* @__PURE__ */ React2.createElement("div", {
        className: "col s6 input-field"
      }, /* @__PURE__ */ React2.createElement("input", {
        type: "number",
        ...
        className: "value",
        id: "roundToDigits",
        value: this.getSetting("roundToDigits", 2),
        onChange: this.handleChange
      }), /* @__PURE__ */ React2.createElement(Label, {
        for: "roundToDigits",
        text: "Decimal places:",
        tooltip: "roundto tooltip"
      }))));
    }
  };

  // admin/src/index.tsx
  var namespace = `tradfri.${instance}`;
  var Root = class extends React3.Component {
    constructor(props) {
      super(props);
      this.state = {
        groups: {},
    ...
    render() {
      return /* @__PURE__ */ React3.createElement(import_iobroker_react_components3.Tabs, {
        labels: ["Settings", "Groups"]
      }, /* @__PURE__ */ React3.createElement(Settings, {
        settings: this.props.settings,
        onChange: this.props.onSettingsChanged
      }), /* @__PURE__ */ React3.createElement(Groups, {
  ...
  $window.load = (settings, onChange) => {
    ...
    ReactDOM.render(/* @__PURE__ */ React3.createElement(Root, {
      settings,
