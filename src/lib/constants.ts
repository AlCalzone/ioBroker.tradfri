...
export const GetNewPskResponse = {
	NEW_PSK_BY_GW: "9091",
};

export const IPSODevice = {
	NAME: "9001",
	CREATED_AT: "9002",
	INSTANCE_ID: "9003",
};
...
export const SmartTaskAction = {
	GROUP_SETTINGS: "9045", // mGroupSettings [<GroupSetting>]
	LIGHT_SETTING: "15013", // [<SmartTaskLightSettings>]
	ONOFF: "5850",
};
export const SmartTaskLightSettings = {
	DIMMER: "5851",
	INSTANCE_ID: "9003",
	TRANSITION_TIME: "5712", // dimmer transition time, default 5
};
export const SmartTaskNotification = {
	INSTANCE_ID: "9003",
	ONOFF: "5850",
